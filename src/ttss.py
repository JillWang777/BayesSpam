...
normFileList = spam.get_File_List(
    r"/Users/wangjing/workshop/code/study/BayesSpam/data/normal")
spamFileList = spam.get_File_List(
    r"/Users/wangjing/workshop/code/study/BayesSpam/data/spam")
testFileList = spam.get_File_List(
    r"/Users/wangjing/workshop/code/study/BayesSpam/data/test")
# 获取训练集中正常邮件与垃圾邮件的数量
